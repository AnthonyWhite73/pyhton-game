...
art_gameover2 = "   `-ysssssso     `+yssy-`    :yys`  `-yys   oyyssssssss:\n `.ydd+-----.   ./hdh-odds.`  +NNmh+.ydNNm   hNNo-------`\n +mNd`` ----.   dmN/` `.dmm/  +NNNNmmNNNNm   hNNo------\n oNNh  `ohNNh   mNNs///+mNN+  +NNmshNyyNNm   hNNhssssso\n -+mdo-  +NNh   mNNs++++mNN+  +NNd`-+`:NNm   hNN+\n   -+mhyyhmmh   dmm:   `hmm+  /mmh`   :mmm   hmmhyyyyyyy/\n    `........   ...`    ...`  `...    `...   ...........`\n \n  `.......     `..     `..`  `..........`   `........`\n .:dmyyyydm+-   mmm:   `dmN+  +Nmmyyyyyyys   hmmdyyyymd:.\n oNNh    +NNh   mNN:   `dNN+  +NNd`          hNN+    hNNo\n oNNh    /NNh   mNNhs`:ymNN+  +NNmyssssy-    hNN/  -smNNo\n oNNh    /NNh   .+mmmddNmh-`  +NNd-.....`    hNNdhhdN+:.`\n /hmd----oNds    ``ohNdh-`    +NNd--------   hNN+.ydNmd-.\n  `ssssssss-`      `.s/`      :yysssssssso   oyy: `:yyss:\n"
...
charList = [["The Player", 33, 1, "Protagonist", 1, 2, False, 5, 3, 3],
...
events_list = (
    ...
    (1,"Strongman", 
        ...
        "He responds: 'You shall not pass. I move... for no man. Unless you can beat me in an arm wrestle!'. What will you do?",        
        "")
    )
...
def speed_target():
    ...
    print("After artfully acrobatting out of his peripheral vision,\n you have the initiative to plan your means of escape")
    x = 0
    ...
    if success_roll == False and int(player_choice) == 1:
        ...
        print("Apparently you forgot to be the ball and the strongman\n judges your movements and lands a killing hit to your face")
        
        game_over(True, False)
    elif success_roll == False and int(player_choice) == 2:
        print("\033[31mfailed\033[0m")
        print("You turn yourself into a sonic pin ball and roll right into\n his foot, which kicks you backs home\n although with the force of the kick you wish it were the hospital")
        
        game_over(True, False)
    elif success_roll == False and int(player_choice) == 3:
        print("\033[31mfailed\033[0m")
        print("You perform a backflip and land on your back\n which shatters your spine and any hope of getting milk")
        
        game_over(True, False)
    else:
        print("\033[32msuccess\033[0m")
        print("Your Speed allows you to escape")
    print("\n")
    
def game_won():
        print("===============================================================================================")
        typewrite("\tCongratulations! The player has successfully got milk!")
        print("-----------------------------------------------------------------------------------------------")
        ...
        typewrite("You walk past crowds on the high street, Can hear chants and echos of your name in your head...\n",0.07)
        time.sleep(0.5)
...
def output_dialogue_after_strong_event():
    ...
    #done! need to fire the game_over() function from here
...
def output_dialogue_after_smart_event():
    ...
    if plrChoice == 1 and charList[0][6] == False:
        ...
        time.sleep(0.5)
        print("")
        typewrite("Adrenaline levels are through the roof and the confidence is sky high after outsmarting the steroid junkie")[0][16], 0.03
        typewrite("The final destination is in sight, you tread on towards to grocery store for the WHITE STUFF")[0][17], 0.03
        typewrite("Green, Blue or Red top... I think its going to be a full fat blue", 0.03)
        print("")
        game_won()
